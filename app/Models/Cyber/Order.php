...
class Order extends Model
{
    ...
    /**
     * Get the meal slot for this order.
     */
    ...
    {
        return $this->hasMany(OrderItem::class, 'cyber_order_id');
    }
    ...
    {
        return $this->hasMany(Payment::class, 'cyber_order_id');
    }
    ...
    {
        do {
            $orderNumber = 'CYB-'.strtoupper(substr(uniqid(), -6));
