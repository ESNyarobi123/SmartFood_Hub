            ...
            @if($product->image)
                <div>
                    ...
                    <div class="inline-block p-4 bg-[#2d2d2d] border border-[#333] rounded-xl shadow-lg">
                        <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="w-64 h-64 object-cover rounded-lg border border-[#444]">
                    </div>
                    <div class="mt-2">
                        <p class="text-xs text-[#6b6b6b]">Current image path:</p>
                        <p class="text-xs text-[#a0a0a0] font-mono break-all mt-1">{{ $product->image }}</p>
                    </div>
                </div>
            @endif
