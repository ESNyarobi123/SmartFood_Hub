...
@section('subtitle', 'Add a new subscription package')

@section('content')
<div class="max-w-4xl">
    <form action="{{ route('admin.food.packages.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="card p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="base_price" id="base_price" value="{{ old('base_price') }}" required min="0" step="0.01"
                        class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-[#5c6b7f] focus:border-[#ff7b54] focus:ring-1 focus:ring-[#ff7b54] transition-colors"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="deliveries_per_week" id="deliveries_per_week" value="{{ old('deliveries_per_week', 2) }}" required min="1" max="7"
                        class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-[#5c6b7f] focus:border-[#ff7b54] focus:ring-1 focus:ring-[#ff7b54] transition-colors">
                ...
                <div>
                    ...
                    <input type="time" name="customization_cutoff_time" id="customization_cutoff_time" value="{{ old('customization_cutoff_time', '18:00') }}" required
                        class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:border-[#ff7b54] focus:ring-1 focus:ring-[#ff7b54] transition-colors">
